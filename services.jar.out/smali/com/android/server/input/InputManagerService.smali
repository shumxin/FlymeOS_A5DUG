...
.field private static final GLOVE_EVENT_TEMP_DISABLED:I = 0x2
...
.method static synthetic access$2100(Lcom/android/server/input/InputManagerService;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/input/InputManagerService;
...
.method static synthetic access$2102(Lcom/android/server/input/InputManagerService;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/input/InputManagerService;
    .param p1, "x1"    # Z
...
.method static synthetic access$2300(Lcom/android/server/input/InputManagerService;II)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/input/InputManagerService;
    .param p1, "x1"    # I
    .param p2, "x2"    # I
...
.method static synthetic access$2500(JLandroid/view/InputEvent;IIIIII)I
    .locals 2
    .param p0, "x0"    # J
...
.method private initGloveMode()V
    ...
    const-string v4, "support_glovemode"

    invoke-static {v3, v4}, Lcom/android/server/input/InputManagerService;->getCustomizationValue(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v4, "htc_glove_mode"
    ...
    iput v3, p0, Lcom/android/server/input/InputManagerService;->mGloveModeSetting:I
    ...
    :goto_1
    invoke-direct {p0, v1}, Lcom/android/server/input/InputManagerService;->setGloveEventEnabledWrapper(I)V
    ...
    const-string v3, " mIsDotViewClosed:"

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-boolean v3, p0, Lcom/android/server/input/InputManagerService;->mIsDotViewClosed:Z
    ...
    invoke-static {v4, v5, v1}, Lcom/android/server/input/InputManagerService;->nativeSetGloveInputFilterEnabled(JZ)V
    ...
    invoke-static {v4, v5, v3}, Lcom/android/server/input/InputManagerService;->nativeSetShowGloveTouches(JI)V
    ...
    invoke-direct {p0, v2}, Lcom/android/server/input/InputManagerService;->getShowGloveTouchesOption(Z)I
    ...
    invoke-static {v4, v5, v2}, Lcom/android/server/input/InputManagerService;->nativeSetGloveInputFilterEnabled(JZ)V
