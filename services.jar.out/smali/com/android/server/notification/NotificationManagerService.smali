...
.method static synthetic access$6000(Lcom/android/server/notification/NotificationManagerService;)J
    .locals 2
    .param p0, "x0"    # Lcom/android/server/notification/NotificationManagerService;
...
.method static synthetic access$6002(Lcom/android/server/notification/NotificationManagerService;J)J
    .locals 1
    .param p0, "x0"    # Lcom/android/server/notification/NotificationManagerService;
    .param p1, "x1"    # J
...
.method public onStart()V
    ...
    .line 876
    new-instance v16, Lcom/android/server/notification/NotificationManagerService$WorkerHandler;
    ...
    .line 884
    .local v5, "extractorNames":[Ljava/lang/String;
    :goto_0
    new-instance v16, Lcom/android/server/notification/RankingHelper;

    invoke-virtual/range {p0 .. p0}, Lcom/android/server/notification/NotificationManagerService;->getContext()Landroid/content/Context;

    move-result-object v17

    new-instance v18, Lcom/android/server/notification/NotificationManagerService$RankingWorkerHandler;
    ...
    invoke-direct {v0, v1, v2, v5}, Lcom/android/server/notification/RankingHelper;-><init>(Landroid/content/Context;Landroid/os/Handler;[Ljava/lang/String;)V
    ...
    .line 887
    new-instance v16, Lcom/android/server/notification/ZenModeHelper;
    ...
    invoke-direct/range {v16 .. v18}, Lcom/android/server/notification/ZenModeHelper;-><init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    new-instance v17, Lcom/android/server/notification/NotificationManagerService$4;
    ...
    invoke-virtual/range {v16 .. v17}, Lcom/android/server/notification/ZenModeHelper;->addCallback(Lcom/android/server/notification/ZenModeHelper$Callback;)V
    ...
    new-instance v16, Landroid/util/AtomicFile;

    new-instance v17, Ljava/io/File;

    const-string v18, "notification_policy.xml"
    ...
    invoke-direct/range {v16 .. v17}, Landroid/util/AtomicFile;-><init>(Ljava/io/File;)V
    ...
    .line 903
    new-instance v16, Lcom/android/server/notification/NotificationUsageStats;

    invoke-virtual/range {p0 .. p0}, Lcom/android/server/notification/NotificationManagerService;->getContext()Landroid/content/Context;

    move-result-object v17

    invoke-direct/range {v16 .. v17}, Lcom/android/server/notification/NotificationUsageStats;-><init>(Landroid/content/Context;)V
    ...
    .line 907
    new-instance v16, Lcom/android/server/notification/NotificationManagerService$NotificationListeners;
    ...
    .line 908
    new-instance v16, Lcom/android/server/notification/ConditionProviders;
    ...
    invoke-direct/range {v16 .. v20}, Lcom/android/server/notification/ConditionProviders;-><init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/notification/ManagedServices$UserProfiles;Lcom/android/server/notification/ZenModeHelper;)V
    ...
    .line 910
    const-class v16, Lcom/android/server/statusbar/StatusBarManagerInternal;
    ...
    check-cast v16, Lcom/android/server/statusbar/StatusBarManagerInternal;
    ...
    invoke-interface/range {v16 .. v17}, Lcom/android/server/statusbar/StatusBarManagerInternal;->setNotificationDelegate(Lcom/android/server/notification/NotificationDelegate;)V

    .line 913
    const-class v16, Lcom/android/server/lights/LightsManager;
    ...
    .line 914
    .local v8, "lights":Lcom/android/server/lights/LightsManager;
    const/16 v16, 0x8

    move/from16 v0, v16

    invoke-virtual {v8, v0}, Lcom/android/server/lights/LightsManager;->getLight(I)Lcom/android/server/lights/Light;
    ...
    sget-object v18, Lcom/android/server/notification/NotificationManagerService;->DEFAULT_VIBRATE_PATTERN:[J
    ...
    invoke-static {v13, v0, v1, v2}, Lcom/android/server/notification/NotificationManagerService;->getLongArray(Landroid/content/res/Resources;II[J)[J
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/android/server/notification/ZenModeHelper;->updateZenMode()V
    ...
    invoke-virtual/range {v16 .. v17}, Lcom/android/server/notification/ManagedServices$UserProfiles;->updateCache(Landroid/content/Context;)V
    ...
    .line 954
    const-string v16, "android.intent.action.USER_ADDED"
    ...
    invoke-direct {v7, v0, v1}, Lcom/android/server/notification/NotificationManagerService$NotifLightBehaviorObserver;-><init>(Lcom/android/server/notification/NotificationManagerService;Landroid/os/Handler;)V

    .line 970
    .local v7, "lightBehaviorObserver":Lcom/android/server/notification/NotificationManagerService$NotifLightBehaviorObserver;
    const/16 v16, 0x0

    move/from16 v0, v16

    invoke-virtual {v7, v0}, Lcom/android/server/notification/NotificationManagerService$NotifLightBehaviorObserver;->onChange(Z)V

    .line 973
    new-instance v12, Lcom/android/server/notification/NotificationManagerService$ReminderBehaviorObserver;
    ...
    invoke-direct {v12, v0, v1}, Lcom/android/server/notification/NotificationManagerService$ReminderBehaviorObserver;-><init>(Lcom/android/server/notification/NotificationManagerService;Landroid/os/Handler;)V

    .line 974
    .local v12, "reminderBehaviorObserver":Lcom/android/server/notification/NotificationManagerService$ReminderBehaviorObserver;
    const/16 v16, 0x0

    move/from16 v0, v16

    invoke-virtual {v12, v0}, Lcom/android/server/notification/NotificationManagerService$ReminderBehaviorObserver;->onChange(Z)V
    ...
    const-string v19, "com.htc.action.REMINDER_TIME_TICK"
    ...
    invoke-static/range {v16 .. v20}, Landroid/app/PendingIntent;->getBroadcastAsUser(Landroid/content/Context;ILandroid/content/Intent;ILandroid/os/UserHandle;)Landroid/app/PendingIntent;
    ...
    const-string v19, "com.htc.permission.APP_PLATFORM"

    const/16 v20, 0x0

    invoke-virtual/range {v16 .. v20}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;)Landroid/content/Intent;
    ...
    .line 984
    .local v9, "manager":Lcom/htc/customization/HtcCustomizationManager;
    if-eqz v9, :cond_2

    .line 986
    const-string v16, "SystemUI"
    ...
    invoke-virtual {v9, v0, v1, v2}, Lcom/htc/customization/HtcCustomizationManager;->getCustomizationReader(Ljava/lang/String;IZ)Lcom/htc/customization/HtcCustomizationReader;

    move-result-object v11

    .line 988
    .local v11, "reader":Lcom/htc/customization/HtcCustomizationReader;
    if-eqz v11, :cond_1

    .line 989
    const-string v16, "NMS_feature_flashlight_color_amber"
    ...
    invoke-interface {v11, v0, v1}, Lcom/htc/customization/HtcCustomizationReader;->readInteger(Ljava/lang/String;I)I

    move-result v16

    sput v16, Lcom/android/server/notification/NotificationManagerService;->LIGHT_COLOR_AMBER:I

    .line 991
    const-string v16, "NMS_feature_flashlight_color_green"
    ...
    sput v16, Lcom/android/server/notification/NotificationManagerService;->LIGHT_COLOR_GREEN:I
    ...
    .line 997
    :cond_1
    const-string v16, "Android_App_Framework"
    ...
    .line 1001
    const-string v16, "NMS_feature_flashlight_during_charging"
    ...
    invoke-interface {v11, v0, v1}, Lcom/htc/customization/HtcCustomizationReader;->readBoolean(Ljava/lang/String;Z)Z
    ...
    const-string v18, "flash notif light during charging="
    ...
    .line 1005
    const-string v16, "NMS_feature_tri_color_led"
    ...
    const-string v18, "support tri-color led="
    ...
    .line 1010
    .end local v11    # "reader":Lcom/htc/customization/HtcCustomizationReader;
    :cond_2
    new-instance v16, Lcom/android/server/notification/NotificationManagerService$Archive;
    ...
    invoke-direct/range {v16 .. v17}, Lcom/android/server/notification/NotificationManagerService$Archive;-><init>(I)V
    ...
    .line 1014
    const-class v16, Lcom/android/server/notification/NotificationManagerInternal;
    ...
    .end local v5    # "extractorNames":[Ljava/lang/String;
    .end local v6    # "filter":Landroid/content/IntentFilter;
    .end local v7    # "lightBehaviorObserver":Lcom/android/server/notification/NotificationManagerService$NotifLightBehaviorObserver;
    .end local v8    # "lights":Lcom/android/server/lights/LightsManager;
    .end local v9    # "manager":Lcom/htc/customization/HtcCustomizationManager;
    .end local v10    # "pkgFilter":Landroid/content/IntentFilter;
    .end local v12    # "reminderBehaviorObserver":Lcom/android/server/notification/NotificationManagerService$ReminderBehaviorObserver;
    ...
    .restart local v5    # "extractorNames":[Ljava/lang/String;
    goto/16 :goto_0
.end method
