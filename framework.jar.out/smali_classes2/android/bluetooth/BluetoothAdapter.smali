...
.method public disableFromPowerSaver()Z
    ...
    const-string v4, "disableFromPowerSaver"
    ...
    invoke-interface {v1}, Landroid/bluetooth/IBluetooth;->getAclConnectedDevices()[Landroid/bluetooth/BluetoothDevice;
    ...
    const-string v4, "disableFromPowerSaver but ACL connected"
...
.method public getProfileProxy(Landroid/content/Context;Landroid/bluetooth/BluetoothProfile$ServiceListener;I)Z
    ...
    invoke-direct {v4, p1, p2}, Landroid/bluetooth/BluetoothHeadset;-><init>(Landroid/content/Context;Landroid/bluetooth/BluetoothProfile$ServiceListener;)V
    ...
    .line 1427
    new-instance v3, Landroid/bluetooth/BluetoothDun;

    invoke-direct {v3, p1, p2}, Landroid/bluetooth/BluetoothDun;-><init>(Landroid/content/Context;Landroid/bluetooth/BluetoothProfile$ServiceListener;)V
    ...
    invoke-direct {v6, p1, p2}, Landroid/bluetooth/BluetoothHealth;-><init>(Landroid/content/Context;Landroid/bluetooth/BluetoothProfile$ServiceListener;)V

    .line 1431
    .local v6, "health":Landroid/bluetooth/BluetoothHealth;
    const/4 v11, 0x1

    goto :goto_0

    .line 1432
    .end local v6    # "health":Landroid/bluetooth/BluetoothHealth;
    :cond_a
    const/16 v11, 0x9
    ...
    invoke-direct {v5, p1, p2}, Landroid/bluetooth/BluetoothHeadsetClient;-><init>(Landroid/content/Context;Landroid/bluetooth/BluetoothProfile$ServiceListener;)V

    .line 1437
    .local v5, "headsetClient":Landroid/bluetooth/BluetoothHeadsetClient;
    const/4 v11, 0x1

    goto :goto_0

    .line 1439
    .end local v5    # "headsetClient":Landroid/bluetooth/BluetoothHeadsetClient;
    :cond_c
    const/4 v11, 0x0
