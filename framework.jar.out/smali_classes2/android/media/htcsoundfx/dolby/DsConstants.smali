...
.method static constructor <clinit>()V
    ...
    .line 25
    .local v0, "FIELD_DS_NO_ERROR":Landroid/media/htcutil/HtcField;
    ...
    .line 27
    .local v1, "FIELD_DS_REQUEST_FAILED_EFFECT_SUSPENDED":Landroid/media/htcutil/HtcField;
    const/4 v5, 0x2
    ...
    .line 28
    .local v4, "list":[Landroid/media/htcutil/HtcField;
    invoke-static {v4, v2}, Landroid/media/htcutil/HtcField;->initFields([Landroid/media/htcutil/HtcField;Ljava/lang/Class;)V

    .line 29
    invoke-static {v0, v8}, Landroid/media/htcutil/HtcField;->getFileld_int(Landroid/media/htcutil/HtcField;Ljava/lang/Object;)I
    ...
    .line 30
    invoke-static {v1, v8}, Landroid/media/htcutil/HtcField;->getFileld_int(Landroid/media/htcutil/HtcField;Ljava/lang/Object;)I
    ...
    .line 35
    .end local v0    # "FIELD_DS_NO_ERROR":Landroid/media/htcutil/HtcField;
    .end local v1    # "FIELD_DS_REQUEST_FAILED_EFFECT_SUSPENDED":Landroid/media/htcutil/HtcField;
    .end local v4    # "list":[Landroid/media/htcutil/HtcField;
    :goto_1
    return-void
