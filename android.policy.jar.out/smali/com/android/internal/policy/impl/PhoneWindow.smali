...
.method protected generateLayout(Lcom/android/internal/policy/impl/PhoneWindow$DecorView;)Landroid/view/ViewGroup;
    ...
    invoke-virtual/range {v47 .. v47}, Landroid/content/Context;->getApplicationInfo()Landroid/content/pm/ApplicationInfo;
    ...
    invoke-virtual {v8, v0, v1}, Landroid/content/res/TypedArray;->getValue(ILandroid/util/TypedValue;)Z
    ...
    new-instance v47, Landroid/util/TypedValue;

    invoke-direct/range {v47 .. v47}, Landroid/util/TypedValue;-><init>()V
    ...
    .line 3399
    .local v46, "windowService":Landroid/view/WindowManager;
    if-eqz v46, :cond_16
    ...
    .line 3414
    .local v42, "targetPreHoneycomb":Z
    :goto_4
    const/16 v47, 0xe
    ...
    .line 3416
    .local v44, "targetPreL":Z
    :goto_6
    invoke-virtual/range {v17 .. v17}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v47

    const v48, #android:bool@target_honeycomb_needs_options_menu#t
    ...
    .line 3418
    .local v41, "targetHcNeedsOptions":Z
    const/16 v47, 0x8
    ...
    .line 3454
    .local v31, "params":Landroid/view/WindowManager$LayoutParams;
    ...
    const v27, #android:layout@screen_swipe_dismiss#t

    .local v27, "layoutResource":I
    :goto_9
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v47 .. v47}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->startChanging()V

    .line 3567
    const/16 v26, 0x0

    .line 3570
    .local v26, "in":Landroid/view/View;
    move-object/from16 v0, p0
    ...
    :cond_26
    :goto_a
    const v47, #android:id@content#t
    ...
    .line 3657
    .local v16, "contentParent":Landroid/view/ViewGroup;
    move-object/from16 v0, p0
    ...
    const-string v48, "Window couldn\'t find content container view"

    invoke-direct/range {v47 .. v48}, Ljava/lang/RuntimeException;-><init>(Ljava/lang/String;)V

    throw v47

    .line 3312
    .end local v16    # "contentParent":Landroid/view/ViewGroup;
    .end local v17    # "context":Landroid/content/Context;
    .end local v21    # "features":I
    .end local v26    # "in":Landroid/view/View;
    .end local v27    # "layoutResource":I
    .end local v30    # "noActionBar":Z
    .end local v31    # "params":Landroid/view/WindowManager$LayoutParams;
    .end local v41    # "targetHcNeedsOptions":Z
    .end local v42    # "targetPreHoneycomb":Z
    .end local v43    # "targetPreIcs":Z
    .end local v44    # "targetPreL":Z
    .end local v45    # "targetSdk":I
    .end local v46    # "windowService":Landroid/view/WindowManager;
    :cond_27
    const v47, 0x10100
    ...
    .restart local v46    # "windowService":Landroid/view/WindowManager;
    :cond_2a
    const/16 v37, 0x0
    ...
    .line 3414
    .restart local v42    # "targetPreHoneycomb":Z
    :cond_2c
    const/16 v43, 0x0
    ...
    .line 3415
    .restart local v43    # "targetPreIcs":Z
    :cond_2d
    const/16 v44, 0x0
    ...
    .line 3418
    .restart local v41    # "targetHcNeedsOptions":Z
    .restart local v44    # "targetPreL":Z
    :cond_2e
    const/16 v30, 0x0
    ...
    .line 3423
    .restart local v30    # "noActionBar":Z
    :cond_2f
    const/high16 v47, 0x40000000    # 2.0f
    ...
    .line 3508
    .restart local v21    # "features":I
    .restart local v31    # "params":Landroid/view/WindowManager$LayoutParams;
    :cond_30
    and-int/lit8 v47, v21, 0x18
    ...
    .line 3510
    new-instance v34, Landroid/util/TypedValue;

    invoke-direct/range {v34 .. v34}, Landroid/util/TypedValue;-><init>()V

    .line 3511
    .local v34, "res":Landroid/util/TypedValue;
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/policy/impl/PhoneWindow;->getContext()Landroid/content/Context;

    move-result-object v47

    invoke-virtual/range {v47 .. v47}, Landroid/content/Context;->getTheme()Landroid/content/res/Resources$Theme;

    move-result-object v47

    const v48, #android:attr@dialogTitleIconsDecorLayout#t
    ...
    .line 3518
    .end local v34    # "res":Landroid/util/TypedValue;
    .restart local v27    # "layoutResource":I
    :goto_b
    const/16 v47, 0x8
    ...
    .end local v27    # "layoutResource":I
    :cond_31
    const v27, #android:layout@screen_title_icons#t
    ...
    const v27, #android:layout@screen_progress#t
    ...
    .line 3531
    .restart local v34    # "res":Landroid/util/TypedValue;
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/policy/impl/PhoneWindow;->getContext()Landroid/content/Context;
    ...
    const v48, #android:attr@dialogCustomTitleDecorLayout#t
    ...
    .end local v27    # "layoutResource":I
    :cond_34
    const v27, #android:layout@screen_custom_title#t
    ...
    const v48, #android:attr@dialogTitleDecorLayout#t
    ...
    const v48, #android:layout@screen_action_bar#t
    ...
    .end local v27    # "layoutResource":I
    :cond_37
    const v27, #android:layout@screen_title#t
    ...
    const v27, #android:layout@screen_simple_overlay_action_mode#t
    ...
    .end local v27    # "layoutResource":I
    :cond_39
    const v27, #android:layout@screen_simple#t

    .restart local v27    # "layoutResource":I
    goto/16 :goto_9

    .line 3576
    .restart local v26    # "in":Landroid/view/View;
    :cond_3a
    new-instance v47, Landroid/widget/FrameLayout;

    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/policy/impl/PhoneWindow;->getContext()Landroid/content/Context;

    move-result-object v48

    invoke-direct/range {v47 .. v48}, Landroid/widget/FrameLayout;-><init>(Landroid/content/Context;)V
    ...
    const-string v48, "android:initialLayout"

    const-string v49, "attr"

    const-string v50, "com.htc"
    ...
    const-string v48, "fakescreenBackgroundColor"
    ...
    const-string v48, "fakescreenDisable"
    ...
    const-string v48, "fakescreenFooterEnable"
    ...
    const-string v48, "fakescreenHeaderEnable"
    ...
    .line 3590
    .local v4, "HTC_FAKESCREEN_STYLEABLE_ATTRS":[I
    const/4 v7, 0x0

    .line 3591
    .local v7, "HTC_FAKESCREEN_STYLEABLE_INDEX_INIT_LAYOUT":I
    const/4 v5, 0x1

    .line 3592
    .local v5, "HTC_FAKESCREEN_STYLEABLE_INDEX_BACKGROUND_COLOR":I
    const/4 v6, 0x4

    .line 3594
    .local v6, "HTC_FAKESCREEN_STYLEABLE_INDEX_HEADER_ENABLE":I
    const/4 v11, 0x0

    .line 3596
    .local v11, "attributeSet":Landroid/content/res/TypedArray;
    :try_start_0
    move-object/from16 v0, v17
    ...
    invoke-static {v0, v1}, Lcom/android/internal/util/RecentAnimationUtil;->getScaleRegion2(Landroid/content/Context;I)Landroid/graphics/Rect;

    move-result-object v33

    .line 3628
    .local v33, "region":Landroid/graphics/Rect;
    move-object/from16 v0, p0
    ...
    .line 3631
    const-string v47, "PhoneWindow"

    new-instance v48, Ljava/lang/StringBuilder;

    invoke-direct/range {v48 .. v48}, Ljava/lang/StringBuilder;-><init>()V

    const-string v49, "generateLayout: thumbnailDrawable:"
    ...
    .line 3636
    .end local v33    # "region":Landroid/graphics/Rect;
    :cond_3e
    const/16 v47, 0x0
    ...
    const-string v49, "generateLayout(): fakescreenLayout:"
    ...
    const-string v49, " fakebackground:"
    ...
    sget-boolean v47, Lcom/android/internal/policy/impl/PhoneWindow;->DEBUG_HTC:Z
    ...
    const-string v49, "generateLayout: fail to obtain htc fake scrren styleable attrs due to "
    ...
    .line 3663
    .end local v4    # "HTC_FAKESCREEN_STYLEABLE_ATTRS":[I
    .end local v5    # "HTC_FAKESCREEN_STYLEABLE_INDEX_BACKGROUND_COLOR":I
    .end local v6    # "HTC_FAKESCREEN_STYLEABLE_INDEX_HEADER_ENABLE":I
    .end local v7    # "HTC_FAKESCREEN_STYLEABLE_INDEX_INIT_LAYOUT":I
    .end local v11    # "attributeSet":Landroid/content/res/TypedArray;
    .end local v35    # "resource":Landroid/content/res/Resources;
    .restart local v16    # "contentParent":Landroid/view/ViewGroup;
    :cond_41
    and-int/lit8 v47, v21, 0x20
    ...
    .line 3665
    .local v32, "progress":Landroid/widget/ProgressBar;
    if-eqz v32, :cond_42
    ...
    .line 3670
    .end local v32    # "progress":Landroid/widget/ProgressBar;
    :cond_42
    move/from16 v0, v21
    ...
    invoke-virtual/range {v47 .. v48}, Landroid/content/Context;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v13

    .line 3683
    .local v13, "background":Landroid/graphics/drawable/Drawable;
    :goto_f
    move-object/from16 v0, p0
    ...
    .line 3691
    .local v24, "frame":Landroid/graphics/drawable/Drawable;
    :goto_10
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v47 .. v48}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->setElevation(F)V
    ...
    invoke-virtual/range {v47 .. v48}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->setClipToOutline(Z)V
    ...
    .line 3833
    .end local v13    # "background":Landroid/graphics/drawable/Drawable;
    .end local v24    # "frame":Landroid/graphics/drawable/Drawable;
    :cond_46
    :goto_11
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v47 .. v47}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->finishChanging()V
    ...
    .restart local v13    # "background":Landroid/graphics/drawable/Drawable;
    goto/16 :goto_f
    ...
    .restart local v24    # "frame":Landroid/graphics/drawable/Drawable;
    goto :goto_10
    ...
    .line 3713
    .restart local v35    # "resource":Landroid/content/res/Resources;
    const/16 v25, 0x0

    .line 3715
    .local v25, "frameBaseView":Landroid/widget/FrameLayout;
    const/16 v29, -0x1

    .line 3718
    .local v29, "matchParent":I
    new-instance v25, Lcom/android/internal/policy/impl/PhoneWindow$FrameBaseView;

    .end local v25    # "frameBaseView":Landroid/widget/FrameLayout;
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/internal/policy/impl/PhoneWindow$FrameBaseView;-><init>(Lcom/android/internal/policy/impl/PhoneWindow;Landroid/content/Context;)V

    .line 3719
    .restart local v25    # "frameBaseView":Landroid/widget/FrameLayout;
    const/16 v47, 0x1
    ...
    .line 3720
    new-instance v47, Landroid/widget/FrameLayout$LayoutParams;
    ...
    const-string v48, "generateLayout: recent_background: 0XFF161616"
    ...
    .line 3772
    .local v28, "lparams":Landroid/widget/FrameLayout$LayoutParams;
    const/16 v47, 0x30
    ...
    .line 3775
    :try_start_1
    const-string v47, "ab_height"

    const-string v48, "dimen"

    const-string v49, "com.htc"
    ...
    .line 3786
    .local v9, "actionBarView":Landroid/view/View;
    move-object/from16 v0, v28
    ...
    .line 3790
    .local v14, "backgroundDrawable":Landroid/graphics/drawable/Drawable;
    const/16 v36, 0x0

    .line 3791
    .local v36, "resourceID":I
    const/16 v47, 0x1
    ...
    const v48, #android:attr@background#t
    ...
    const v48, #android:attr@actionBarStyle#t
    ...
    .line 3793
    .local v40, "ta":Landroid/content/res/TypedArray;
    const/16 v47, 0x0
    ...
    .end local v14    # "backgroundDrawable":Landroid/graphics/drawable/Drawable;
    const v47, -0xdadadb
    ...
    .line 3798
    .restart local v14    # "backgroundDrawable":Landroid/graphics/drawable/Drawable;
    :cond_4b
    ...
    invoke-virtual {v0, v14}, Lcom/android/internal/policy/impl/PhoneWindow;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 3814
    .end local v9    # "actionBarView":Landroid/view/View;
    .end local v12    # "attrs":[I
    .end local v14    # "backgroundDrawable":Landroid/graphics/drawable/Drawable;
    .end local v28    # "lparams":Landroid/widget/FrameLayout$LayoutParams;
    .end local v36    # "resourceID":I
    .end local v40    # "ta":Landroid/content/res/TypedArray;
    :cond_4c
    move-object/from16 v0, p0
    ...
    .line 3819
    .restart local v28    # "lparams":Landroid/widget/FrameLayout$LayoutParams;
    const/16 v47, -0x1
    ...
    .line 3825
    .local v23, "footerBarView":Landroid/view/View;
    move-object/from16 v0, v23
    ...
    .end local v23    # "footerBarView":Landroid/view/View;
    .end local v28    # "lparams":Landroid/widget/FrameLayout$LayoutParams;
    :cond_4d
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v47 .. v49}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;)Landroid/view/View;

    move-result-object v20

    .line 3738
    .local v20, "fakescreenView":Landroid/view/View;
    new-instance v47, Landroid/widget/FrameLayout$LayoutParams;
    ...
    const-string v49, "app fakescreenLayout takes "
    ...
    .line 3744
    .end local v20    # "fakescreenView":Landroid/view/View;
    .end local v38    # "start":J
    :cond_4e
    const-string v47, "common_app_bkg"

    const-string v48, "drawable"
    ...
    .line 3746
    .restart local v36    # "resourceID":I
    if-eqz v36, :cond_4f
    ...
    const-string v48, "common_app_bkg resource not found!"
    ...
    .line 3757
    .local v15, "backgroundView":Landroid/view/View;
    move-object/from16 v0, p0
    ...
    .line 3776
    .end local v15    # "backgroundView":Landroid/view/View;
    ...
    .line 3777
    .restart local v19    # "e":Landroid/content/res/Resources$NotFoundException;
    sget-boolean v47, Lcom/android/internal/policy/impl/PhoneWindow;->DEBUG_HTC:Z
    ...
    const-string v49, "generateLayout: get ab_height fail, "
    ...
    .line 3803
    .end local v19    # "e":Landroid/content/res/Resources$NotFoundException;
    .restart local v9    # "actionBarView":Landroid/view/View;
    .restart local v12    # "attrs":[I
    .restart local v14    # "backgroundDrawable":Landroid/graphics/drawable/Drawable;
    .restart local v36    # "resourceID":I
    .restart local v40    # "ta":Landroid/content/res/TypedArray;
    :cond_51
    if-eqz v36, :cond_52
    ...
    const-string v48, "common_app_bkg_top_src resource not found!"
